...
pub fn build(b: *std.Build) void {
    ...
    lib.root_module.addCSourceFiles(.{
        ...
        .files = &.{
            ...
            "implementations/keymgmt/template_kmgmt.c",
            ...
            "implementations/rands/fips_crng_test.c",
            ...
            "implementations/rands/seed_src_jitter.c",
    ...
    switch (target.result.cpu.arch) {
        .x86_64 => lib.root_module.addCSourceFiles(.{
            .root = b.path("crypto"),
            .files = &.{
                "aes/aes-x86_64.s",
